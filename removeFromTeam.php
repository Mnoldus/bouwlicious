...
$sql = mysqli_query($conn, "SELECT * FROM signup INNER JOIN teams ON signup.name = teams.naam WHERE `signup`.`unique_id` = {$_GET['id']}");
...
<div class="container">
    <div class="buttons">
        <p class="titel">Weet u zeker dat u <span class="highlight"><?php echo $row["name"] ." van de club ". $_GET['club']; ?></span> wilt verwijderen?</p>
