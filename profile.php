...
<?php    if($_SESSION['unique_id'] != '815362009'){
        ...
        $select = "SELECT * FROM signup INNER JOIN goals ON signup.name = goals.naam INNER JOIN team_table ON goals.team = team_table.club WHERE signup.unique_id = {$_SESSION['unique_id']}";
