...
<div class="center">
        ...
        <?php
                ...
                $select = "SELECT * FROM signup INNER JOIN goals ON signup.name = goals.naam INNER JOIN team_table ON goals.team = team_table.club WHERE signup.id = {$_GET['id']}";
...
foreach($result as $rows):
    ...
    <div class="goalnumbers">
        ...
        <?php endforeach;
                        $sql = "SELECT * FROM signup INNER JOIN goals ON signup.name = goals.naam INNER JOIN team_table ON goals.team = team_table.club WHERE signup.id = {$_GET['id']}";
